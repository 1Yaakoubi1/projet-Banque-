 ...
 * 
 */
@WebServiceClient(name = "ServiceBanqueService", targetNamespace = "http://serviceBanque/", wsdlLocation = "http://localhost:8586/?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8586/?wsdl");
